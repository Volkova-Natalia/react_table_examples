...
export function onTableDragUpdate(dragUpdateObj: DragUpdate, b: ResponderProvided, currentColOrder: any, setColumnOrder: Function) {
...
export function TableDraggableCell(props: { provided: any, snapshot: any, children: any }) {
  return (
    <div
